...
*   Node.js
*   Express.js
*   Google Generative AI SDK (`const model = genAI.getGenerativeModel({ model: 'gemini-3.5-flash' });`)
*   Dotenv & CORS
...
```bash
git clone [https://github.com/username-lo/smart-chef-ai.git](https://github.com/username-lo/smart-chef-ai.git)
cd smart-chef-ai
